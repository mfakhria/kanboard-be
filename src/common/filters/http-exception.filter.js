...
var HttpExceptionFilter = function () {
    ...
    var HttpExceptionFilter = _classThis = /** @class */ (function () {
        ...
        HttpExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            this.logger.error("".concat(request.method, " ").concat(request.url, " ").concat(status, " - ").concat(JSON.stringify(message)), exception instanceof Error ? exception.stack : undefined);

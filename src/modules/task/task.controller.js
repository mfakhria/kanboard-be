...
var TaskController = function () {
    ...
    var TaskController = _classThis = /** @class */ (function () {
        ...
        TaskController_1.prototype.create = function (dto, userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.create(dto, userId)];
                });
            });
        };
        TaskController_1.prototype.findOne = function (taskId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.findById(taskId)];
                });
            });
        };
        TaskController_1.prototype.update = function (taskId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.update(taskId, dto)];
                });
            });
        };
        TaskController_1.prototype.delete = function (taskId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.delete(taskId)];
                });
            });
        };
        TaskController_1.prototype.move = function (taskId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.move(taskId, dto)];
                });
            });
        };
        TaskController_1.prototype.assign = function (taskId, assigneeId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.assignMember(taskId, assigneeId)];
                });
            });
        };
        TaskController_1.prototype.addComment = function (taskId, content, userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.taskService.addComment(taskId, content, userId)];
                });
            });
        };
    ...
    (function () {
        ...
        _move_decorators = [(0, common_1.Patch)(':id/move')];
        _assign_decorators = [(0, common_1.Patch)(':id/assign')];
